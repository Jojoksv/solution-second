...
export function MapPanel() {
  ...
  // Hashes to skip Leaflet rebuilds when data hasn't actually changed
  ...
  useEffect(() => {
    ...
    // Skip expensive Leaflet rebuild when only timestamp changed
  ...
  useEffect(() => {
    ...
    // Skip rebuild when fill percentages haven't changed
