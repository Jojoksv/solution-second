  ...
  return (
    <aside className="w-[240px] bg-[#0A0A0A] border-r border-[#2A2A2A] flex flex-col h-full flex-shrink-0 z-50">
      ...
      <nav className="flex-1 py-4 px-3 flex flex-col gap-1">
        <div className="text-[10px] uppercase font-bold tracking-widest text-[#555555] mb-2 px-2">Overview</div>
      ...
      <div className="p-3 border-t border-[#2A2A2A]">
        <a href="#" className="flex items-center gap-3 px-2 py-2 text-[13px] text-[#888888] font-medium rounded-[6px] hover:bg-[#141414] hover:text-[#EDEDED] transition-colors mb-2">
        ...
        <div className="flex items-center gap-3 px-2 py-2 rounded-[6px] hover:bg-[#141414] cursor-pointer transition-colors">
          ...
          <div className="flex flex-col">
            <span className="text-[#EDEDED] text-[12px] font-medium leading-none mb-1">Supervisor</span>
